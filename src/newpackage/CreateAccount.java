...
public class CreateAccount extends HttpServlet {
    ...
    // acasa luam cu copy paste sa arate frumos si sa nu dea erori, pentru a avea formularul !!!!!!!!!
    // ACASA: adauga, + afisare cos
    // acum facem bucata in care exportam datele din cos
    // http://localhost/Mtb/modul/functia/param1
    // PENTRU PROIECTUL X SI O:  primul parm coloana, al doilea linia, pentru updatare
